...
////
////
Ce fichier est synchronisé avec le fichier en anglais version svn 1827961
il peut y avoir des chapitres en plus, donc non traduit en anglais, mais alors c'est signalé en début du chapitre en question
////
= Apache OFBiz Developer Manual
The Apache OFBiz Project
Release 17.12, La traduction en français est en cours, donc de nombreuse partie sont encore en anglais, elle est basé sur la version 1850155 de la version anglaise.
:imagesdir: ./images
ifdef::backend-pdf[]
...
:toclevels: 3
:jbake-type: page
:jbake-tags: ofbiz, documentation, fr
...
Comment la documentation est organisé, avec quels outils est-elle réalisé, quels sont les conventions et toutes les
autres questions concernant la gestion de la document et son élaboration sont traité dans un document dédié.

cf link:documentation_guidelines.html[documentation_guidelines]

Il existe plusieurs documentations, chacune avec un objectif ou un lectorat cible, pour l'instant chacune est représenté par
un fichier dans link:.[le répertoire racine] .
...
include::../../plugins/vuejs/src/docs/asciidoc/FrontJsVueJs_fr.adoc[leveloffset=+1]
...
//doc coming from Webhelp Example
include::../../plugins/examplefjs/src/docs/asciidoc/dev_by_example_fr.adoc[leveloffset=+2]


=== Web tools

include::../../plugins/examplefjs/src/docs/asciidoc/example_fr.adoc[leveloffset=+2]
...
Pour plus de détail se référer à la https://ofbswdadoc.ofbizextra.org/OFBiz_SeleniumWebDriver_fr.html[documentation de ce projet]
